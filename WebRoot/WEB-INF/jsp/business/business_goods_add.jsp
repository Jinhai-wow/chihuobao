			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="container-fluid">
					...
					<form id="businessForm" class="form-horizontal" role="form"
						...
						action="${pageContext.request.contextPath }/addGood.action"
						method="post">
						...
						<div class="detail-con row">
							...
							<div class="goods-img col-sm-12 col-md-4 col-lg-4">
								<div id="previewBig">
									<img name="goods.goodPic" src="img/null.png"
										class="img-thumbnail img-responsive">
								</div>
								<a href="javascript:;" class="a-upload col-xs-12"> <input
									type="file" name="goodPic" id="goodPic"
									onchange="previewBig(this)">点击这里上传图片
								</a>
							</div>
							...
							<div class="goods-msg col-sm-12 col-md-8 col-lg-8">
								<div class="form-group">
									...
									<div class="col-xs-9">
										<input id="goodName" type="text" name="goods.goodName"
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<div class="input-group">
											<select id="goodStyleId" class="form-control"
												name="goods.goodStyleId">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<div class="input-group">
											...
											<input id="price" type="text" name="goods.price"
												class="form-control">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<div class="input-group">
											<input id="quantity" type="text" name="goods.quantity"
												class="form-control" value="">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										...
										<select id="sellState" class="form-control" id="sell-state"
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<textarea id="goodIntro" class="form-control col-sm-10"
											id="good-intro" name="goods.goodIntro" rows="3" value=""></textarea>
									</div>
								</div>
								<div class="form-group">
