									...
									<div class="col-xs-5">
										<div class="input-group">
											<input type="text" name="storerAccount.email"
												...
												data-toggle="modal" data-target="emailModal"><small>重新绑定邮箱</small></a>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-5">
										<div class="input-group">
											<input type="text" name="storerAccount.telephone"
												...
												class="btn btn-default btn-xs input-group-addon"
												data-toggle="modal" data-target="phoneModal"><small>重新绑定手机</small></a>
										</div>
									</div>
								</div>
								<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">输入邮箱信息</h4>
				</div>
				...
				<input type="hidden" name="id"
					...
					<div class="col-xs-12">
						...
						<a href="javascript:;" class="btn btn-primary btn-xs" onclick="sendEmailCode()">发送验证码</a>
					</div>
					<label for="emailCode" class="col-xs-2 col-sm-1 control-label">输入验证码</label>
					<div class="col-xs-5">
						<div class="input-group">
							<input type="text" name="storerAccount.email" class="form-control" id="emailCode">
						</div>
					</div>
				</div>
