  ...
  <body>
    ...
    <div id="toolbar">
    	...
    	<a id="detailBtn" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-more'" 
   		                  pageUrl="${pageContext.request.contextPath }/manager/goodsCharts.action">查看图表</a>
   ...
   <script type="text/javascript">
    	$(function() {
   		...
   		buttons.splice(1, 0, {
   			...
   			handler : function(target) {
   				var url= "${pageContext.request.contextPath }/manager/selectBestGoodsList.action";
    			 $('#dd').datebox('setValue', '');
    	...
    	$('#dd').datebox({
   			onSelect : function(date) {
   				...
   				var url= "${pageContext.request.contextPath }/manager/selectBestGoodsByTime.action";
    		...
    		$("#list").datagrid({
				...
				url:"${pageContext.request.contextPath }/manager/selectBestGoodsList.action",  		
    			columns:[[
    				{field:"id",title:"id",width:100,hidden:true},     
    				{field:"shopName",title:"商店名称",width:200},
    				{field:"shopStyleName",title:"商店类型",width:200},
    				{field:"goodsName",title:"商品名称",width:200},
    				{field:"total",title:"销售次数",width:100},
    				{field:"goodsMoney",title:"商品价格",width:200},
    				{field:"payTime",title:"时间",width:300,formatter:function(value,row,index){
    					if(value != null) {
    								da = new Date(value) ;
    ...
    //导出execl
    		$("#exportBtn").click(function() {
    			...
    			form.attr('action', '${pageContext.request.contextPath }/manager/bestGoodsExport.action');
    			//添加input
    			var input1 = $("<input>");
