		...
		// 选择时间 
			...
			$('#todate').datebox({
				...
				if(fromdate != null){
					...
					/* $.post("${pageContext.request.contextPath}/manager/goodsChartsListBydate.action",{"fromdate":fromdate,"todate":todate},function(data) {
						
						//alert(data[0].goodsName);
    		...
    		////////////////////////////		
					 ...
					 //});
				var url = "${pageContext.request.contextPath}/manager/goodsChartsListBydate.action"+"?fromdate="+fromdate+"&todate="+todate;
			...
			$.post("${pageContext.request.contextPath}/manager/goodsChartsList.action", function(data) {
