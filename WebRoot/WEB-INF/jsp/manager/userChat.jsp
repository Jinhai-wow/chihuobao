...
$(function () {
    ...
    function getData(){
		...
		return "<i style='color:red;font-size: 10px'>"+year+"-"+month+"-"+day+"&nbsp;"+hour+":"+minute+":"+second+":</i><br><i style='color:#ff7c3d;font-size: 10px'>${user.user.phone}:</i><br>";
    }
    
    
    /* 拿过来改了下的代码 */
    var userphone='${user.user.phone}';
    alertBox(userphone,'user.user.phone');
    ...
    function ws_init(){
    	var target="ws://localhost:8080/CHB/chat?username="+userphone;
		...
		ws.onmessage=function(event){
			...
			if(msg.usernames!=undefined){
				...
				if(userphone != "aaa"){
					...
					$("#userList").append('<li><img src="img/shop-bg.jpg"><span data-value="'+userphone+'">'+userphone+'</span></li>');
