...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=m4RmTMMoEEuF3qefYjDRkw5gxUDOK8Zs"></script>
...
////////////////////////////////////////////////////
	...
	/* 初始化时总价格 */
		...
		initTotalprice=initTotalprice+($("#goodsprice"+i+"").text()*$(this).val())/1;
		i++;
		});
		 
		$("#totalprice").text(initTotalprice);
		}
	...
	function totalPrice() {
		...
		$("tbody").children().find(":input").each(function() {
			...
			totalprice = totalprice / 1.0 + ($("#goodsprice" + i + "").text() * $(this).val());
...
<body>
<form id="signupForm" action="${pageContext.request.contextPath}/submitOrder.action" method="post">
	<!--     下左 -->
	<input type="hidden" name="ordergoodsinfo" id="ordergoodsinfo">
	<input type="hidden" name="userid" value="${userid}" id="userid">
	<input type="hidden" name="shopcartid" value="${shopcart.shopcartid}" id="shopcartid">
	<input type="hidden" name="shopid" value="${shopcart.shopid}">
		...
		<div class="col-md-6 containerRightDiv">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<span class="glyphicon glyphicon-map-marker"></span>&nbsp;&nbsp;<span>${userfromtable.username}
					</span> <span>${userfromtable.phone}</span> <span>${addressfromtable.address}</span>
				</div>
			</div>
			<!--  付款方式 -->
			<div class="panel panel-default">
								...
								<div class="row" style=" margin-bottom:10px;">
									...
									<div class="radio col-sm-2" style="margin-top:-26px;">
										...
										<label> <input type="radio" name="optionsRadios"
											class="col-sm-2" id="optionsRadios1" value="option1" checked>男
										</label>
									</div>
	...
	<!-- <div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto; display:none;"></div> -->
									 ...
									 <div  style="display: none"></div>
										位置: <input type="text" class="form-control map-search" 
											placeholder="请输入小区、大厦、或学校" id="suggestId">
          ...
          <div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto; display:none;"></div>
								...
								<div class="form-group">
									<!-- <label for="username" class="col-sm-2 control-label" style="padding-bottom:40px;">位置</label> -->
									<div class="col-sm-6">
										详细地址: <input type="text" class="form-control" id="username"
											placeholder="单元、门牌号">
									</div> 
								</div>
