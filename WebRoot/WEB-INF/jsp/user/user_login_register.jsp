...
<html>
  <head>
	...
	<script type="text/javascript" src="js/user_login_register.js"></script>
  </head>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="from-option">
				<form class="form-horizontal" id="login-note" action="${pageContext.request.contextPath }/user/loginRegisterByMessage.action" method="post">
					<div class="form-group has-warning">
						<section class="MessageLogin-FsPlX">
							<input type="tel" id="loginphone" class="form-control input-lg" maxlength="11" name="user.phone" placeholder="手机号" value=""/>
